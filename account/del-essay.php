...
*/
require_once("./delessay_crud.php");
require_once("./delEssayAns_crud.php");
require_once("./delStep1_crud.php");
require_once("./delEssayAnsTemp_crud.php");
  ...
  <div id="wrapper">
	...
	<?php
		...
		if($status){
			...
			echo "<div class='form-group'><label class='control-label col-sm-12' for=''>PLEASE FIRST FILL YOUR DELEGATES APPLICATION STEP 1 FORM IN ORDER TO PROCEED:</label><div class='col-sm-8'>";
		}
	?>  
  </form>
  </div>   
